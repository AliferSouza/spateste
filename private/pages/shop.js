async function shop(props) {  
    ...
    const dadosSelecionado = props.Dados.produtos.filter(d => d.categoria === "oleos");
    ...
    const html = () => {
        ...
        <comp-perfoleos data-a="/#/shop/shopproduto/#oleos" data-use-width="80px"  data-use-height="80px"  data-id="oleos">Oleos</comp-perfoleos>
